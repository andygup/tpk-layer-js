...
define([
    ...
    function(declare,Extent,query,SpatialReference,DataStream,TileInfo,TiledMapServiceLayer,TilesStore,TilingScheme,zip,X2JS,Evented){
        return declare("esri.TPKLayer",[TiledMapServiceLayer,Evented],{
            ...
            throttleMillis: 250,                    // Number of milliseconds to throttle getUrl requests.
...
//                    this._throttler(
                        this._getInMemTiles(url,layersDir, level, row, col, function (result) {
...
//                    ,this.throttleMillis);
            ...
            /**
             * Set the wait property in millis to slow down the getUrl request rate.
                ...
                this.store.retrieve(url, function(success, offlineTile){
                    if( success )
                    {
                        ...
                        if (typeof  bundleX != "undefined") {
                            ...
                            var n = new Date(); console.log("time0: " + n.getSeconds() +":" + n.getUTCMilliseconds())

                            this._throttler(
                                function(){
                                    that._bundleXReader(bundleX, offset, function (pointer) { //var n = new Date(); console.log("time: " + n.getSeconds() +":" + n.getUTCMilliseconds())
                                        that._bundleReader(bundle, pointer, function (str) { var n = new Date(); console.log("time: " + n.getSeconds() +":" + n.getUTCMilliseconds())
