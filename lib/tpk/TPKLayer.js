        ...
        return declare("esri.TPKLayer",[TiledMapServiceLayer,Evented],{
            ...
            _parseConfCdi: function(tilesInfo,callback){
                ...
                if(m_conf_index != -1){
                    ...
                    var str = this._bin2String(m_conf_i);
             ...
             * @private
             */
            _bin2String: function(/* ArrayBuffer */ buffer){
                var str = "";
                var arr = new Uint8Array(buffer,0);
             ...
             * @private
             */
            _bin2Base64: function(/* ArrayBuffer */arrayBuffer,/* int */ position){
...
//                return btoa(string);
                ...
                var string = this._bin2String(chunk);
                return btoa(string);
            },
