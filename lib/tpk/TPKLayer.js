...
define([
    ...
    function(declare,Extent,query,SpatialReference,DataStream,TileInfo,TiledMapServiceLayer,TilesStore,TilingScheme,zip,X2JS,Evented){
        return declare("esri.TPKLayer",[TiledMapServiceLayer,Evented],{
             ...
             * Slower devices may need more throttling when there are many tiles in an extent.
             * This will really be noticeable as you zoom closer to the earth.
             * @param func
             * @param wait
             * @returns {Function}
             * @private
             */
            _throttler: function (func, wait) {
                var timeout;
                return function() {
