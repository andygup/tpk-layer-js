define([
    ...
    "esri/layers/TileInfo","esri/layers/TiledMapServiceLayer","tiles/TilesStore",
    "tpk/zip","tpk/xml2json","dojo/Evented"],
    function(declare,Extent,query,SpatialReference,DataStream,TileInfo,TiledMapServiceLayer,TilesStore,zip,X2JS,Evented){
        return declare("test",TiledMapServiceLayer,{
            MAX_DB_SIZE: 100,       //Recommended maximum size in MBs
            ...
            constructor:function(/* zip */ tiles){
                ...
                if( /*false &&*/ this._store.isSupported() )
                {
                    this._store.init(function(result){
                        if(result == false){
                            throw "There was a problem initiating IndexedDB";
                        }
                        else{
